...
{
	this->numberOfSprites = 40;					///로딩해야 하는 스프라이트 개수
	this->loadedNumberOfSprites = 0;			///로딩된 스프라이트 개수
...
bool LoadingScene::onTouchBegan(Touch * touch, Event * event)
{
	...
	CCDirector::getInstance()->replaceScene(TransitionSlideInL::create(0.5f, mainScene));
